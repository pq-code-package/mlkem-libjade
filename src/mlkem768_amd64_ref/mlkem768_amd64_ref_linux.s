...
Ljade_kem_mlkem_mlkem768_amd64_ref_dec$189:
	...
	movzbw	13251(%rsp,%rcx), %si
	movw	%si, %di
	shrw	$4, %di
	andw	$15, %si
	shlw	$8, %si
	orw 	%si, %dx
	movzbw	13252(%rsp,%rcx), %si
	shlw	$4, %si
	orw 	%si, %di
	addq	$3, %rcx
	cmpw	$3329, %dx
...
Ljade_kem_mlkem_mlkem768_amd64_ref_dec$226:
	subq	$8, %rdi
	movq	$0, (%rsp,%rdi)
	jne 	Ljade_kem_mlkem_mlkem768_amd64_ref_dec$226
	movq	%rsi, %rsp
	lfence
	ret
...
Ljade_kem_mlkem_mlkem768_amd64_ref_enc$188:
	...
	movzbw	13235(%rsp,%rcx), %si
	movw	%si, %di
	shrw	$4, %di
	andw	$15, %si
	shlw	$8, %si
	orw 	%si, %dx
	movzbw	13236(%rsp,%rcx), %si
	shlw	$4, %si
	orw 	%si, %di
	addq	$3, %rcx
	cmpw	$3329, %dx
...
Ljade_kem_mlkem_mlkem768_amd64_ref_enc$205:
	subq	$8, %rdi
	movq	$0, (%rsp,%rdi)
	jne 	Ljade_kem_mlkem_mlkem768_amd64_ref_enc$205
	movq	%rsi, %rsp
	lfence
	ret
...
Ljade_kem_mlkem_mlkem768_amd64_ref_keypair$179:
	...
	movzbw	10211(%rsp,%rcx), %si
	movw	%si, %di
	shrw	$4, %di
	andw	$15, %si
	shlw	$8, %si
	orw 	%si, %dx
	movzbw	10212(%rsp,%rcx), %si
	shlw	$4, %si
	orw 	%si, %di
	addq	$3, %rcx
	cmpw	$3329, %dx
...
Ljade_kem_mlkem_mlkem768_amd64_ref_keypair$189:
	subq	$8, %rdi
	movq	$0, (%rsp,%rdi)
	jne 	Ljade_kem_mlkem_mlkem768_amd64_ref_keypair$189
	movq	%rsi, %rsp
	lfence
	ret
...
Ljade_kem_mlkem_mlkem768_amd64_ref_enc_derand$205:
	subq	$8, %rdi
	movq	$0, (%rsp,%rdi)
	jne 	Ljade_kem_mlkem_mlkem768_amd64_ref_enc_derand$205
	movq	%rsi, %rsp
	lfence
	ret
...
Ljade_kem_mlkem_mlkem768_amd64_ref_keypair_derand$189:
	subq	$8, %rdi
	movq	$0, (%rsp,%rdi)
	jne 	Ljade_kem_mlkem_mlkem768_amd64_ref_keypair_derand$189
	movq	%rsi, %rsp
	lfence
	ret
L_i_poly_tomsg$1:
